//Both the players roll the dice respectivly when their turn comes by 
// manually entering 'R'/'r' from keyboard and it gives of all the details of the moves
...
int main()
{
    ...
    while(1)
    {
        cout<<"Player "<<game.active_ply+1<<" Enter 'R'/'r' to roll the dice..| ";
        cin>>c;
